...
import org.openqa.selenium.WebElement;
		...
		public class ecommerseprojectfive {
					  ...
					  Thread.sleep(1200);
					   ...
					   //.deselectByVisibleText("78");
					    ...
					    Thread.sleep(1000);
						 ...
						 //    driver.switchTo().frame("frameName2");
						  ...
						  //   driver.switchTo().frame("frameName3");
						      ...
						      */
						      ...
						      WebElement frameElement = driver.findElement(By.name("checkout-frames-form"));
						     ...
						     WebElement frameName = driver.findElement(By.name("cardnumber"));
						     ...
						     WebElement frameName2 = driver.findElement(By.name("exp-date"));
						  ...
						  //   driver.switchTo().frame("frameName3");
						     ...
						     WebElement frameName3 = driver.findElement(By.name("cvc"));
						     System.out.println("Element found!");
					     ...
					     //   WebElement hiddenElement324 = (WebElement) js101.executeScript("return document.getElementById('elementId');");

					        // Now, you have the hidden element, you can interact with it as needed
					        // For example, you can make it visible using JavaScript
				
						 // Attempt to switch to the frame with retry mechanism
					        boolean frameSwitched = false;
					        int attempts = 0;
					        
					    
					        while (!frameSwitched && attempts < 3) { // Retry up to 3 times
					            try {
					            	
					            	
					                WebDriverWait wait23 = new WebDriverWait(driver, null);
					                
					                wait23.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt(By.id("cko-3ds2-iframe")));
					                frameSwitched = true; // Set to true if frame switch is successful
					            } catch (StaleElementReferenceException e) {
					                // Handle StaleElementReferenceException by retrying
					                attempts++;
					                System.out.println("Retrying frame switch attempt: " + attempts);
					            }
					        }

					        // Now, the driver is switched to the frame, you can locate the hidden element within the frame
					        if (frameSwitched) {
					            showHiddenElementInFrame(driver);
					        } else {
					            System.out.println("Failed to switch to frame after multiple attempts.");
					        }

					        // Switch back to the main content if needed
					        driver.switchTo().defaultContent();

					        // Continue with other actions on the main content or perform additional tasks
					    }

					    public static void showHiddenElementInFrame(WebDriver driver) {
					        try {
					            // Locate and show the hidden element within the frame here
					        } catch (StaleElementReferenceException e) {
					            // Handle StaleElementReferenceException if needed
					        }
						    ...
						    WebElement autentification =driver.findElement(By.name("password"));
